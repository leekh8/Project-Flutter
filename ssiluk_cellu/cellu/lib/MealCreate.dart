...
void main() {
  runApp(const MealCreate());
}
// FIXME : 클래스명 변경
// Generated by: https://www.figma.com/community/plugin/842128343887142055/
class MealCreate extends StatelessWidget {
  const MealCreate ({super.key});
  ...
  void _saveDietPlan() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          context,              // FIXME : main2 >> 내 식단 작성 페이지
                          ...
                          child: Material( // Material 위젯 추가
                            ...
                            child: InkWell(
                              onTap: () {
                                _saveDietPlan();
                                Navigator.push(
                                  context,                 // FIXME : main2 >> 내식단 작성 페이지
                                  MaterialPageRoute(builder: (context) => Mymeal()),
                                );
                              },
                              child: SizedBox(
